...
async function seed() {
    try {
        ...
        const checkResult = await (0, index_1.query)('SELECT COUNT(*) FROM departments');
        ...
        const orgsResult = await (0, index_1.query)('SELECT id, name FROM organisations');
        ...
        await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [firstOrgId, 'IT Department', 'IT']);
        console.log('IT Department created successfully');
        // Human Resources
        console.log('Inserting Human Resources...');
        await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [firstOrgId, 'Human Resources', 'HR']);
        console.log('Human Resources created successfully');
        // Administration
        console.log('Inserting Administration...');
        await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [firstOrgId, 'Administration', 'ADMIN']);
        ...
        if (orgsResult.rows.length > 1) {
            ...
            await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [secondOrgId, 'Research & Development', 'R&D']);
            ...
            await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [firstOrgId, 'Research & Development', 'R&D']);
        }
        ...
        if (orgsResult.rows.length > 2) {
            ...
            await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [thirdOrgId, 'Field Operations', 'FIELD']);
            console.log('Field Operations created successfully');
            console.log('Inserting Logistics...');
            await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [thirdOrgId, 'Logistics', 'LOG']);
            console.log('Logistics created successfully');
        }
        else {
            // Fall back to first organisation
            console.log('No third organisation, using first for operations departments');
            await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [firstOrgId, 'Field Operations', 'FIELD']);
            await (0, index_1.query)('INSERT INTO departments (organisation_id, name, department_code) VALUES ($1, $2, $3)', [firstOrgId, 'Logistics', 'LOG']);
        }
...
//# sourceMappingURL=002_departments.js.map